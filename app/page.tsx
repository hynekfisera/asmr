  ...
  return (
    <main className="flex flex-col justify-center items-center">
      <div className="max-w-screen-md flex flex-col justify-center items-center gap-6">
        <h1 className="text-5xl font-light text-gray-200 shadow text-center">Interactive ASMR experience</h1>
        ...
        <p className="text-gray-300 text-center">Two ASMR triggers will appear. Once you decide which one you like more, click on the button below the video. After you finish the test, you will be able to see your #1 trigger.</p>
